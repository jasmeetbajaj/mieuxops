      ...
      <div className="flex-1 max-w-xl">
        <div className="relative group">
          ...
          <input 
            ...
            className="w-full h-9 bg-secondary border-none rounded-md pl-10 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-primary focus:bg-white transition-all"
          />
        </div>
      </div>
